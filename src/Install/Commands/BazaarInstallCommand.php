...
class BazaarInstallCommand extends Command
{
    ...
    public function handle(PanelRegistry $registry): int
    {
        ...
        $this->components->info('Run `php artisan migrate` to create the roles/permissions (spatie/laravel-permission), settings (spatie/laravel-settings), and media (spatie/laravel-medialibrary) tables.');
